                ...
                <div className="aspect-[1/1] sm:aspect-[6/5] w-full overflow-hidden bg-slate-100 flex items-center justify-center relative">
                  ...
                  {voucher.stockQuantity === 0 ? (
                    <div className="absolute inset-0 flex items-center justify-center backdrop-blur-[2px]">
                      <div className="bg-slate-900/80 text-white px-3 py-1.5 rounded-lg text-xs font-semibold tracking-wider uppercase shadow-xl transform border border-slate-700">Out of Stock</div>
                    </div>
                  ) : (
