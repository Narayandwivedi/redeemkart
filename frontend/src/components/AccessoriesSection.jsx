  ...
  const accessoryCategories = [
    {
      ...
      priceRange: "ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹1,299 - ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹12,999",
    ...
    },
    {
      ...
      priceRange: "ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹2,999 - ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹25,999",
    ...
    },
    {
      ...
      priceRange: "ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹1,599 - ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹18,999",
    ...
    },
    {
      ...
      priceRange: "ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹2,499 - ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹15,999",
    ...
    },
    {
      ...
      priceRange: "ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹8,999 - ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹45,999",
    ...
    },
    {
      ...
      priceRange: "ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹899 - ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¹8,999",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 shadow-lg border border-purple-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-gradient-to-r from-violet-500 to-orange-500 rounded-xl flex items-center justify-center mb-3 shadow-lg">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
